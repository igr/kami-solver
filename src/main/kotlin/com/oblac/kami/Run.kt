...
val puzzles = mapOf(
	...
	"game-5" to Puzzle(5, 9, solutionColor = 1) { it.removeTilesOfColor(4) },
	"game-52" to Puzzle(52, 9, solutionColor = 1) { it.removeTilesOfColor(4) },
...
fun main() {
	val puzzle = puzzles["game-5"] ?: error("Invalid puzzle name")
